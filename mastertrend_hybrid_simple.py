#!/usr/bin/env python3
"""
MASTERTREND HYBRID SIMPLE STRATEGY
Version hybride simplifiée et robuste
Objectif: Combiner les meilleurs aspects sans erreurs de division
"""
...
class SimpleHybridMasterTrend(bt.Strategy):
    """
    Stratégie MasterTrend HYBRIDE SIMPLIFIÉE - Robuste et efficace
    """
    ...
    params = (
        ...
        # Trading Sessions
        ('trading_start', datetime.time(8, 0)),
    ...
    def detect_market_regime(self):
        ...
        # Analyse de tendance
        price_vs_sma20 = (self.data.close[0] - self.sma_20[0]) / self.sma_20[0] * 100 if self.sma_20[0] > 0 else 0
        price_vs_sma50 = (self.data.close[0] - self.sma_50[0]) / self.sma_50[0] * 100 if self.sma_50[0] > 0 else 0
        ...
        volatility_low = self.volatility[0] < np.mean([self.volatility[-i] for i in range(1, min(21, len(self.data)))])
    ...
    def calculate_signal_strength(self, long_signal, short_signal):
        ...
        if long_signal:
            ...
            if bb_range > 0:
                bb_position = (self.data.close[0] - self.bb.bot[0]) / bb_range * 100
                if bb_position < 30:
                    strength += 0.2
                elif bb_position < 50:
                    strength += 0.1
    ...
    def check_rules(self):
        """Vérification des règles de trading"""
    ...
    def calculate_position_size(self):
        ...
        if stop_distance > 0 and self.data.close[0] > 0:
            ...
            max_size = account_value * 0.1 / self.data.close[0]  # Max 10%
    ...
    def next(self):
        ...
        long_condition = long_condition and signal_quality_ok and filters_ok
        short_condition = short_condition and signal_quality_ok and filters_ok
    ...
    def stop(self):
        ...
        self.log(f'=== RÉSULTATS MASTERTREND HYBRIDE SIMPLE ===')
        ...
        # Évaluation finale
        if total_return >= 5:
            self.log('\n🏆 EXCELLENT! Stratégie hybride simple performante!')
        elif total_return >= 2:
            self.log('\n✅ BON! Stratégie hybride simple efficace')
        elif total_return >= 0:
...
if __name__ == '__main__':
    # Test sur différentes timeframes et paires
    test_configs = [
    ...
    for config_name, filename, timeframe, compression in test_configs:
        print(f'\n{"="*60}')
        print(f'🚀 TESTING MASTERTREND HYBRID SIMPLE - {config_name}')
        print(f'🧬 Mode: HYBRIDE SIMPLIFIÉ')
        ...
        try:
            ...
            cerebro.addstrategy(SimpleHybridMasterTrend)
    ...
    # Résumé final
    print(f'\n{"="*80}')
    print('🏆 RÉSUMÉ FINAL - MASTERTREND HYBRID SIMPLE')
    print('='*80)
    ...
    if valid_results:
        ...
        if avg_return >= 2:
            print('\n🎉 STRATÉGIE HYBRIDE SIMPLE VALIDÉE! Performance consistante.')
        elif avg_return >= 0:
            print('\n✅ Stratégie prometteuse, optimisation recommandée.')
        else:
